...
As we mentioned before in 4.1.2 table\ref{tab:my_label}, Hydrocodone in the state KY is the most often occurred case by statistics. So we choose it to be a sample for us to derive its source. Considering that we have just 8-year data, so we only predict 2 years forward and backward to ensure the accuracy. Thus, With data from 2010 to 2017 inputted into our model, we predict how the identification counts for the Hydrocodone cases distribute in KY in 2008, which is shown in table \ref{tab:2008}, and Buprenorphine cases in Ohio (OH) in 2018, which is shown in table \ref{2018} and figure \ref{KY_Hydrocodone_5}.
...
GUERNSEY&OH39059&81.52033854514106\\
...
\begin{figure}[htbp]
	...
	\caption{Hydrocodone identification counts  from 2008 to 2012 in  Kentucky (KY)} 
