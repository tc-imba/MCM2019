...
$X= \left( \begin{array}{cccc}x_{1}^{T} \\x_{2}^{T} \\
\vdots  \\x_{n}^{T}\end{array} \right )=\left( \begin{array}{cccc}1& x_{11}&\cdots &x_{1p}\\1& x_{21}&\cdots &x_{2p}\\\vdots&\vdots&\ddots &\vdots\\1& x_{n1}&\cdots &x_{np}\end{array} \right ),$

$\beta = \left( \begin{array}{cccc}\beta_{0} \\\beta_{1} \\
\vdots  \\\beta_{p}\end{array} \right ),\varepsilon =\left( \begin{array}{cccc}\varepsilon_{0} \\\varepsilon_{1} \\
\vdots  \\\varepsilon_{n}\end{array} \right ).$
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \subcaption{The ratio of data retained after dimensionality reduction among five states in 2010-2017 against different components}
        \label{fig:pca_state_ratio}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figure/pca_state_score.eps}
        \subcaption{The $R^2$ of linear regression among five states in 2010-2017 against different components }
        \label{fig:pca_state_score}
    \end{subfigure}
    \caption{PCA and LR results among five states in 2010-2017 against different components}\label{fig:pca_state}
\end{figure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \subcaption{The $R^2$ of Linear Regression among five states in 2010 against different components}
        \label{fig:pca_state_2010_score}
    \end{subfigure}
    \caption{PCA and LR results among five states in 2010 against different components}\label{fig:pca_state_2010}
\end{figure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \subcaption{The ratio of data retained after dimensionality reduction in 2010-2017 against different aggregations}
        \label{fig:pca_year_ratio}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figure/pca_year_score.eps}
        \subcaption{The $R^2$ of Linear Regression rre in 2010-2017 against different aggregations}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \subcaption{The ratio of data retained after dimensionality reduction in PA in 2010-2017 against different aggregations}
        \label{fig:pca_year_PA_ratio}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figure/pca_year_PA_score.eps}
        \subcaption{The $R^2$ of data retained after dimensionality reduction in PA in 2010-2017 against different aggregations}
        \label{fig:pca_year_PA_score}
    \end{subfigure}
    \caption{PCA results of data retained after dimensionality reduction in PA in 2010-2017 against different aggregations}\label{fig:pca_year_PA}
\end{figure}
