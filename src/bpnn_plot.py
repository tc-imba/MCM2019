...
df = pd.read_csv('../result/bpnn_source_KY_Hydrocodone.csv')
...
for i in range(5):
    ...
    endpts = list(np.geomspace(10, 400, 5))
    ...
    plotly.plotly.plot(fig, filename='KY_Hydrocodone_' + str(i + 1), fileopt='overwrite', auto_open=True)
